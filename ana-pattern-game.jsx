...
const PATTERNS = [
  // NUCLEAR PATTERNS
  {
    ...
    confusedWith: [],
    goblinNote: 'The empty glass — no antibodies here. The droids you are looking for are not present.',
    frequency: 'baseline',
    type: 'negative',
  },
  {
  ...
  },
  {
    ...
    goblinNote: 'The great impostor — looks alarming but AC-2 alone actually means you\'re probably fine. It\'s anti-DFS70, not the goblins running amok. Knowing this pattern saves patients from unnecessary panic.',
    frequency: 'common',
    type: 'denseSpeckled',
  },
  {
    ...
    goblinNote: 'When Betty the B cell makes anti-centromere antibodies, this is the pattern. Betty\'s up to something here — this one\'s more scleroderma than lupus or other SARD\'s.',
